...
import InfoIcon from "../CustomSvg/InfoIcon";
    ...
    return (
        <div>
            <label
                ...
                className="p-[8px_10px] group  flex justify-between items-start"
            >
                <div className="flex items-start gap-2">
                    <input
                        className="!w-[18px] !translate-y-[0.25em]  !border-[1px] !h-[18px] "
                        id={name}
                        name="license"
                        type="radio"
                        checked={active}
